...
#  Scenario: Check that we can't login into the application when providing invalid credentials (invalid username + invalid password)
...
#    Then I cannot login into the application and receive error message:"Epic sadface: Username is required"
  ...
  Scenario Outline: Check that we can't login into the application when providing invalid credentials
