...
@invalid_login7
Scenario: Check login functionality when username is none and incorrect password
  Given I am on the saucedemo login page
...
@invalid_login8
Scenario: Check login functionality when username is incorrect and password incorrect
  Given I am on the saucedemo login page
...
@invalid_login9
Scenario: Check login functionality when username is locked and incorrect password
  Given I am on the saucedemo login page
